...
from google.generativeai.types import GenerationConfig  # Updated import
...
# Promotion Generation (using gemini-2.0-flash-exp for images)
...
# Chart Generation (using gemini-1.5-flash for text)
...
if __name__ == "__main__":
    ...
    test_genai_api_key()  # Test API key on startup
